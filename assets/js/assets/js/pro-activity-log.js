/* ============================================================
   ACTIVITY LOG — Eventos recientes de documentación
...
const activityLogData = [
    ...
    },
    {
        ...
        type: "Anomalía",
        item: "/api/v1/orders",
        detail: "Endpoint marcado como deprecated sigue referenciado en un manual de soporte."
    },
    {
        time: "2025-01-06 17:45",
        type: "Revisión",
        item: "Feature Flags Playbook",
        detail: "Se detectaron referencias a flags retiradas en la release 4.2."
    },
    {
        time: "2025-01-06 15:10",
        type: "Actualización",
        item: "QA Checklist – Release 4.3",
        detail: "Se añadieron nuevos casos de prueba para el módulo de autenticación."
    },
    {
